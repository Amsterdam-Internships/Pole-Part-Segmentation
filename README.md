...
2) Our sample data is shared [here](https://drive.google.com/file/d/1nd5KL_dtK9fzQisFcb0sMufKO2F8tIV9/view?usp=sharing). Download the zip file, extract the three folders (`train_ply`, `test_ply`, and `val_ply`) the and copy them to the `./KPConv/Data` folder.
